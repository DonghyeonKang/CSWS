        ...
        <>
          <Title>인바운드 규칙 편집</Title>
            <Container>
                ...
                {data.map((i)=>{
                    return(<ExistingInboundRule data={data} setData={setData} i={i}/>)})
                }
                {newData.map((i)=>{
                    return(<NewInboundRule data={newData} setData={setNewData} i={i}/>)})
                }
                </tbody>
                </Rules>
            </Container>
            ...
            <div>
                ...
                <SaveRules onClick={saveRules}>인바운드 규칙 저장</SaveRules>
            </div>
          </BtnSection>
        </>
    );
